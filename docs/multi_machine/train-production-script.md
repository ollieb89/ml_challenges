# Production Training Script - Optimized for Your Hardware

Save as: `~/Development/Projects/ai-ml-pipeline/ai-cluster/scripts/train_production.py`
...
from unsloth import FastLanguageModel, unsloth_monkey_patch
...
def prepare_dataset(
    ...
    if dataset_name == "wikitext":
        ...
        dataset = load_dataset("openwebtext", split=split[:1000])
    else:
...
def save_checkpoint(
    ...
    checkpoint_path = Path(checkpoint_dir) / f"epoch_{epoch+1}_loss_{loss:.4f}.pt"
...
def main(args):
    ...
    # Setup
    rank, world_size, local_rank, logger = setup_distributed()
    ...
    for epoch in range(args.num_epochs):
        ...
        if epoch_loss < best_loss:
            ...
            save_checkpoint(model, optimizer, epoch, epoch_loss, rank)
...
### Single GPU Test (verify on each machine)
...
**Terminal 2 - Worker 1 (192.168.1.101):**
```bash
...
**Terminal 3 - Worker 2 (192.168.1.102):**
```bash
...
```
[2026-01-19 04:05:30] INFO: ============================================================
[2026-01-19 04:05:30] INFO: DISTRIBUTED TRAINING INITIALIZED
[2026-01-19 04:05:30] INFO: ============================================================
[2026-01-19 04:05:30] INFO: Total Nodes (World Size): 3
[2026-01-19 04:05:30] INFO: Current Rank: 0
[2026-01-19 04:05:30] INFO: Local Rank: 0
[2026-01-19 04:05:30] INFO: GPU: NVIDIA GeForce RTX 5070 Ti
[2026-01-19 04:05:30] INFO: GPU Memory: 12.00 GB
[2026-01-19 04:05:30] INFO: ============================================================
[2026-01-19 04:05:45] INFO: Loading model: unsloth/tinyllama-bnb-4bit
[2026-01-19 04:05:50] INFO: Model loaded successfully
[2026-01-19 04:06:00] INFO: Loading dataset: wikitext
[2026-01-19 04:06:15] INFO: Tokenizing dataset...
[2026-01-19 04:06:30] INFO: Epoch [1/3] Step [10/1250] Loss: 0.8432 LR: 1.60e-05
[2026-01-19 04:06:45] INFO: Epoch [1/3] Step [20/1250] Loss: 0.7821 LR: 3.20e-05
[2026-01-19 04:07:00] INFO: Epoch 1 completed - Avg Loss: 0.7543
```

## Optimization Notes

1. **Batch Size**: Set to 1 per GPU for Unsloth DDP (required)
2. **Gradient Accumulation**: Increase `--gradient-accumulation-steps` to simulate larger batch size
3. **Model Size**: TinyLlama (1.1B) for testing, upgrade to Llama-2-7B after verification
4. **Network**: All on same LAN (critical for performance)
5. **Memory**: With 4-bit quantization and LoRA, even Llama-2-13B should fit
...
tensorboard --logdir ~/ai-cluster/logs
...
Check logs in `~/ai-cluster/logs/training_rank*.log` for rank-specific issues.
